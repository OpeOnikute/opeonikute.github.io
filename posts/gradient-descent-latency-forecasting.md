...
All of the experiments live in a notebook in my [autoscaling-playground](https://github.com/OpeOnikute/autoscaling-playground) repo: [`notebooks/traffic_forecasting.ipynb`](https://github.com/OpeOnikute/autoscaling-playground/blob/main/notebooks/traffic_forecasting.ipynb) [^2].
...
[^1]: YT video: [Machine Learning for Monitoring | Predict Your System's Future with Gradient Descent](https://www.youtube.com/watch?v=vNDvFW2pOxQ)
